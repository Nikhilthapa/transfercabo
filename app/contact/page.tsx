      ...
      <section className="bg-white py-10 md:py-12 lg:py-16">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-5xl mx-auto">
            {/* Phone/WhatsApp Card */}
            <div className="border border-gray-200 rounded-xl p-4 md:p-6 lg:p-8 text-center shadow-sm hover:shadow-md transition-shadow" style={{ backgroundColor: '#fafaf9' }}>
              ...
              <h3 className="font-bold text-black text-base md:text-lg mb-1">Phone / WhatsApp</h3>
              <p className="text-black text-xs md:text-sm mb-1 md:mb-2">And messenger</p>
            ...
            {/* Location Card */}
            <div className="border border-gray-200 rounded-xl p-4 md:p-6 lg:p-8 text-center shadow-sm hover:shadow-md transition-shadow sm:col-span-2 md:col-span-1" style={{ backgroundColor: '#fafaf9' }}>
              <div className="flex justify-center mb-3 md:mb-4">
                <div className="bg-blue-100 w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center">
                  <div className="w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 relative">
                    <Image
