      ...
      <section className="container mx-auto px-4 md:px-8 py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-4 md:mb-6">
            <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-3xl mx-auto text-left">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div>
              <h3 className="text-base md:text-lg font-normal text-gray-700 mb-1 text-center">
