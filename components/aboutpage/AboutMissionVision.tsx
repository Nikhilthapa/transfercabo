    ...
    <section className="bg-white py-12 md:py-20">
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-Montserrat font-bold text-black mb-4 md:mb-6">
            Our Mission & Vision
          </h2>
          <p className="font-Montserrat font-medium text-[#6f6f6f] text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-[0_10px_15px_rgba(0,0,0,0.1),0_4px_6px_rgba(0,0,0,0.1)]">
            <h3 className="text-2xl md:text-3xl font-Montserrat font-bold text-black mb-4 md:mb-6">
              Our Mission
            </h3>
