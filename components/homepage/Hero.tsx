    ...
    <section className="relative h-[120vh] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 flex items-center h-[calc(100vh-100px)] min-h-[500px]">
        <div className="max-w-3xl">
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-blue-500 mb-3 md:mb-4">
            Cheap Transfers Cabo
          </h2>
          <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-8">
            Your Journey Starts In Comfort
          </h3>
          <p className="text-lg md:text-2xl text-white font-semibold mb-3 md:mb-4">
            Reliable • Comfortable • Affordable
          </p>
          <p className="text-base md:text-xl text-white mb-6 md:mb-10">
            Start Your Cabo Getaway With Stress-Free Private Transportation
          </p>
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
            <Link href="/cabo/reservation" className="bg-blue-600 text-white px-8 md:px-10 py-3 md:py-4 rounded-md font-semibold text-base md:text-lg hover:bg-blue-700 transition shadow-lg text-center">
              Book Your Ride Today
            </Link>
            <Link href="/activity" className="border-2 border-white text-white px-8 md:px-10 py-3 md:py-4 rounded-md font-semibold text-base md:text-lg hover:bg-white/10 transition text-center">
              Explore Activities
            </Link>
          </div>
        </div>
