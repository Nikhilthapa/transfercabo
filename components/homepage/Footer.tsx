        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3 md:gap-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-white/10 hover:bg-white/20 rounded flex items-center justify-center transition">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-white/10 hover:bg-white/20 rounded flex items-center justify-center transition">
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
