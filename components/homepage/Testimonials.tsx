    ...
    <section className="container mx-auto px-4 md:px-8">
      ...
      <div className="relative max-w-5xl mx-auto px-8 sm:px-12 md:px-16 lg:px-20">
        ...
        <button
          ...
          className="absolute left-0 sm:-left-2 md:-left-4 top-1/2 -translate-y-1/2 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center group hover:scale-110"
          aria-label="Previous testimonial"
        >
          <svg 
            className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-600 group-hover:text-blue-600 transition-colors" 
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
        ...
        <div className="bg-white rounded-xl md:rounded-2xl lg:rounded-3xl shadow-xl relative p-4 sm:p-6 md:p-8 lg:p-12">
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full mx-auto overflow-hidden border-2 sm:border-[3px] md:border-4 border-blue-100 mb-4 sm:mb-5 md:mb-6" style={{ marginBottom: '24px' }}>
            <Image
        ...
        <button
          ...
          className="absolute right-0 sm:-right-2 md:-right-4 top-1/2 -translate-y-1/2 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center group hover:scale-110"
